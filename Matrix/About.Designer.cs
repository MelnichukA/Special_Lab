namespace Matrix
{
    partial class About
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "Матричный калькулятор";
            ...
            this.labelCompanyName.Text = "Аня Мельничук";
            ...
            this.textBoxDescription.Text = "Матричный калькулятор позволяет сложить матрицы, вычесть, умножить и транспониров" +
    "ать.";
            // 
            // okButton
            // 
